    ...
    return (
        <div className="min-h-screen bg-[#f5f7fa] flex items-center justify-center px-4">
            <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                <h1 className="text-3xl font-black text-gray-900 mb-2 text-center">Увійти</h1>
                <p className="text-gray-400 text-sm text-center mb-6">Раді бачити вас знову</p>
                ...
                <p className="text-center text-sm text-gray-400 mt-6">
                    Немає акаунту?{" "}
                    <NavLink to="/register" className="text-[#0057b8] font-semibold hover:underline">
                        Зареєструватись
                    </NavLink>
                </p>
            </div>
